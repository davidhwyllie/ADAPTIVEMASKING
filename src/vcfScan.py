...
class regionScan_from_genbank(vcfScan):
	...
	def __init__(self,
		...
		Arguments:
			...
			method: either 'CDS' or 'All'.  Ignored if regenerating object based on stored regions.
...
class test_regionScan_1d(unittest.TestCase):
	...
	def runTest(self):
		...
		# is used to create a new one	
		genbank_file_name = os.path.join("..", "testdata", "NC_0103971.1.gb")
		rs = regionScan_from_genbank(genbank_file_name = genbank_file_name, method = 'CDS')
		region1 = rs.regions
